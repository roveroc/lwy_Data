...
- (void)viewDidLoad {
    ...
    switch (self.functionNo) {
        case 5:
        {
            ...
            model_1.imgString = @"lightingImg.png";
        ...
        case 6:
        {
            ...
            PriceModel *model_2 = [[PriceModel alloc] init];
            model_2.imgString = @"sadeImg.png";
            model_2.titleString = @"加急处理-专家立刻处理 ￥188";
            model_2.titleColorString = @"1E90FF";
            model_2.msgString = @"       具备原创独家线路策划能力，网站线路为原创独立研发；讲究深度体验、以其独特旅游组织方式,讲究深度";
            
            PriceModel *model_3 = [[PriceModel alloc] init];
            model_3.imgString = @"sadeImg.png";
            model_3.titleString = @"排队处理-按顺序处理 ￥88";
            model_3.titleColorString = @"8A2BE2";
            model_3.msgString = @"       具备原创独家线路策划能力，网站线路为原创独立研发；讲究深度体验、以其独特旅游组织方式,组织方式";
...
- (void)cutomLabelAttribite:(UILabel *)lab msg:(NSString *)msg
{
    ...
    //设置文字大小
    [attributStr addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:15] range:rang];
    //设置文字背景色
...
{
    PriceModel *model = [self.msgArray objectAtIndex:indexPath.row];
    NSString *p_str = [[model.titleString componentsSeparatedByString:@" "] objectAtIndex:1];
    NSString *m_str = [[model.titleString componentsSeparatedByString:@" "] objectAtIndex:0];
    PayMoneyViewController *payCom = [[PayMoneyViewController alloc] init];
    payCom.priceValue = p_str;
    payCom.contentMsg = m_str;
